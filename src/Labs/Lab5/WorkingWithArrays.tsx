...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input defaultValue={todo.id} className="form-control w-50 float-start"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
            <input type="checkbox" defaultChecked={todo.completed} className="form-check-input w-25 float-start me-2"
